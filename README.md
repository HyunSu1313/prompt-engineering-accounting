...
프롬프트의 효과는 일반 질문 방식과 템플릿 적용 방식을 비교하여 평가합니다.

- 평가 기준: 근거 정확성, 출력 일관성, 실무 활용성, 할루시네이션 통제, 커뮤니케이션 품질
- 상세 내용: [Prompt Evaluation](./evaluation.md)
- 상세 적용 사례: [Case Studies](./case_studies/)
